    ...
    class EpochHander
    {
        public static string FromUnixTime1(string unixTime, string _dbSourceFile)
        {
            ...
            try
            {
                ...
                //Allows for handling varing length of numeric values including some with decimals.
        ...
        //public static string FromUnixTime1(string unixTime)
        //{
        //    if (string.IsNullOrEmpty(unixTime) | !IsNumber(unixTime) | unixTime == "0")
        //        return unixTime;
        ...
        //        // Add the number of seconds in UNIX timestamp to be converted.
        //        dateTime = dateTime.AddSeconds(dunixTime / 1000000).ToUniversalTime();
        ...
        //        if (dateTime.Year < DateTime.Now.Year &
        //            dateTime.Year <= DateTime.Now.Year - 3 ||
        //            dateTime.Year.ToString() == "1601")
        //        {
        //            double convertedTime = (dunixTime - 11644473600000000) / 1000000;//divide by 1000000 because we are going to add Seconds on to the base date
        //            DateTime date = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        //            dateTime = date.AddSeconds(convertedTime);
        //        }

        //        if (dateTime.Year.ToString() == "1970")
        //        {
        //            dateTime = new System.DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        //            dateTime = dateTime.AddSeconds(dunixTime);
        //        }

        //        if (dateTime.Year.ToString() == "1982")
        //        {
        //            //From Mac epoch which starts at year 2001.
        //            dateTime = new System.DateTime(2001, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        //            dateTime = dateTime.AddSeconds(dunixTime);
        //        }

        //        if (dateTime.Year == DateTime.Now.Year ||
        //             dateTime.Year >= DateTime.Now.Year - 2)
        //        {
        //            //years match so we must be done.
        //            return dateTime.ToString();
        //        }
        ...
        //        //if (dateTime.Year.ToString() == "1642")
        //        //{
        //        //    dateTime = new System.DateTime(1970, 1, 1, 0, 0, 0, 0);
        //        //    //dateTime = dateTime.AddSeconds(dunixTime / 10000000).ToUniversalTime();
        //        //    dateTime = dateTime.AddSeconds((dunixTime / -11644473600000000) / 1000000);
        //        //}
